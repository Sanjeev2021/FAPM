...
async function generateEmbeddingsForVisuels(options: {
  ...
  console.log('\n🚀 Génération des embeddings pour new_03_visuels\n');
...
generateEmbeddingsForVisuels({ forceRegenerate, limit }).catch(console.error);
