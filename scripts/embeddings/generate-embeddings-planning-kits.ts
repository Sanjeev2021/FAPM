...
async function generateEmbeddingsForPlanningKits(options: {
  ...
  console.log('\n🚀 Génération des embeddings pour new_02_planning_kits_media\n');
...
generateEmbeddingsForPlanningKits({ forceRegenerate, limit }).catch(console.error);
