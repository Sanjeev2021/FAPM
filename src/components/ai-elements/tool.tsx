...
export const Tool = ({ className, ...props }: ToolProps) => (
  <Collapsible
    className={cn("group not-prose mb-4 w-full rounded-xl border border-gray-100 bg-white shadow-sm", className)}
    {...props}
  />
);
...
export const ToolContent = ({ className, ...props }: ToolContentProps) => (
  <CollapsibleContent
    className={cn("space-y-4 px-4 pb-4 text-popover-foreground", className)}
    {...props}
  />
);
